            ...
            {items.map((item, idx) => (
                ...
                >
                    ...
                    <Image
                        ...
                        src={item.image}
                        alt={item.name}
                        className="object-cover border-none !m-0 p-2 rounded-full h-14 w-14 border-2 group-hover:scale-105 group-hover:z-30 bg-black-300 relative transition duration-500"
                    />
                </div>
            ))}
        </>
